 ...
 */
class AdminPixPaid extends WC_Email
{
	/**
	 * Pix.
	 *
	...
	{
		$this->id = 'wc_piggly_pix_admin_confirmed';
		$this->title = CoreConnector::__translate('(Admin) Pix Pago');
		...
		// email template path
		$this->template_html  = 'woocommerce/emails/admin-pix-paid.php';
		$this->template_plain = 'woocommerce/emails/plain/admin-pix-paid.php';
