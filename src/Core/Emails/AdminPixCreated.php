 ...
 */
class AdminPixCreated extends WC_Email
{
	/**
	 * Pix.
	 *
	...
	{
		$this->id = 'wc_piggly_pix_admin_created';
		$this->title = CoreConnector::__translate('(Admin) Pix Criado');
		$this->description = CoreConnector::__translate('E-mail enviado quando o Pix foi criado para um pedido.');
		...
		// email template path
		$this->template_html  = 'woocommerce/emails/admin-pix-created.php';
		$this->template_plain = 'woocommerce/emails/plain/admin-pix-created.php';
	 ...
	 * @return void
	 */
	public function trigger ( PixEntity $pix, $order, $order_id )
	{
		$this->setup_locale();
	...
	public function get_default_subject() {
		return CoreConnector::__translate('Novo pedido #{order_number} com Pix realizado');
	}
	...
	public function get_default_heading() {
		return CoreConnector::__translate('Você recebeu um novo pedido!');
	}
