 ...
 */
class CustomerPixExpired extends WC_Email
{
	/**
	 * Pix.
	 *
	...
	{
		$this->id = 'wc_piggly_pix_tx_expired';
		$this->title = CoreConnector::__translate('Pix Expirado');
		$this->description = CoreConnector::__translate('E-mail enviado quando o Pix expirou.');
		...
		// email template path
		$this->template_html  = 'woocommerce/emails/customer-pix-expired.php';
		$this->template_plain = 'woocommerce/emails/plain/customer-pix-expired.php';
	...
	{
		if ( $status !== PixEntity::STATUS_EXPIRED )
		{ return; }
	...
	public function get_default_subject() {
		return CoreConnector::__translate('Pagamento expirado para o pedido #{order_number}');
	}
	...
	public function get_default_heading() {
		return CoreConnector::__translate('O pagamento foi expirado e precisa ser reiniciado');
	}
