...
use Exception;
use Piggly\WooPixGateway\Vendor\Piggly\Pix\Emv\Field;
use Piggly\WooPixGateway\Vendor\Piggly\Pix\Emv\MPM;
use Piggly\WooPixGateway\Vendor\Piggly\Pix\Emv\MultiField;
...
class Reader
{
    ...
    protected function getEMV(string $id, string &$code) : array
    {
        ...
        return ['id' => $id, 'size' => $size, 'value' => $this->getData($code, \intval($size))];
    }
    /**
