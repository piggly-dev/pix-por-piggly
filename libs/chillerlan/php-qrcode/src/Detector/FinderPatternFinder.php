...
final class FinderPatternFinder
{
    ...
    private const MAX_MODULES = 177;
    // 1 pixel/module times 3 modules/center
    private const CENTER_QUORUM = 2;
    ...
    private function selectBestPatterns() : array
    {
        ...
        usort($this->possibleCenters, fn(FinderPattern $a, FinderPattern $b) => $a->getEstimatedModuleSize() <=> $b->getEstimatedModuleSize());
