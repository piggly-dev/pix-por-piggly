...
use Throwable;
use function chr, implode, intdiv, is_string, mb_convert_encoding, mb_detect_encoding, mb_detect_order, mb_internal_encoding, mb_strlen, ord, sprintf, strlen;
/**
...
final class Hanzi extends QRDataModeAbstract
{
    ...
    public static function convertEncoding(string $string) : string
    {
        ...
        $detected = mb_detect_encoding($string, null, \true);
        if ($detected === \false) {
