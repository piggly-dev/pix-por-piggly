 ...
 * @license      Apache-2.0
 */
namespace Piggly\WooPixGateway\Vendor\chillerlan\QRCode\Decoder;
...
use Piggly\WooPixGateway\Vendor\chillerlan\QRCode\Common\GenericGFPoly;
use Piggly\WooPixGateway\Vendor\chillerlan\QRCode\Common\GF256;
...
final class ReedSolomonDecoder
{
    ...
    private function decodeWords(array $received, int $numEccCodewords) : array
    {
        ...
        [$sigma, $omega] = $this->runEuclideanAlgorithm(GF256::buildMonomial($numEccCodewords, 1), new GenericGFPoly(array_reverse($syndromeCoefficients)), $numEccCodewords);
