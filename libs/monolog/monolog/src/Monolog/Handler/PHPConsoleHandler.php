...
use Piggly\WooPixGateway\Vendor\PhpConsole\Connector;
use Piggly\WooPixGateway\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use Piggly\WooPixGateway\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Piggly\\WooPixGateway\\Vendor\\Monolog\\'],
    ...
    {
        if (!\class_exists('Piggly\\WooPixGateway\\Vendor\\PhpConsole\\Connector')) {
