 ...
 */
namespace Piggly\WooPixGateway\Vendor\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = \array_map('Piggly\\WooPixGateway\\Vendor\\Monolog\\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**
