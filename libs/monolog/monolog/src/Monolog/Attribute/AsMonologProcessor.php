 ...
 */
namespace Piggly\WooPixGateway\Vendor\Monolog\Attribute;
...
class AsMonologProcessor
{
     ...
     */
    public function __construct(public ?string $channel = null, public ?string $handler = null, public ?string $method = null)
    {
    }
}
